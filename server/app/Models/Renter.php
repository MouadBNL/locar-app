 ...
 * @property-read ?string $driver_license_issuing_date
 * @property-read ?string $driver_license_expiration_date
 ...
 * @property-read ?string $passport_issuing_date
 * @property-read ?string $passport_expiration_date
