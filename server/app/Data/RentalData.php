    ...
    public static function fromModel(Rental $rental): self
    {
        ...
        return new self(
            ...
            renter: new RenterData(
                ...
                id_card_issuing_date: $rental->renter->id_card_issuing_date,
                id_card_expiration_date: $rental->renter->id_card_expiration_date,
                ...
                driver_license_scan_document: null,
                id_card_scan_document: null,
