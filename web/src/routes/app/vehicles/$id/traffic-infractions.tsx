...
export const Route = createFileRoute('/app/vehicles/$id/traffic-infractions')({
    ...
    <div>
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t('traffic:traffic_infractions_vehicle_description')}</CardDescription>
        </CardHeader>
        <CardContent>
