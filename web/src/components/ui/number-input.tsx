...
export function NumberInput({ ref, stepper, thousandSeparator, placeholder, defaultValue, min = -Infinity, max = Infinity, onValueChange, onChange, fixedDecimalScale = false, decimalScale = 0, suffix, prefix, value: controlledValue, ...props }: NumberInputProps & { ref?: React.RefObject<HTMLInputElement | null> }) {
  ...
  useEffect(() => {
    if (controlledValue !== undefined) {
      ...
      setValue(controlledValue ?? undefined);
    }
  }, [controlledValue]);
